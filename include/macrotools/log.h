...
#define LOG_LEVEL_STRING_ERROR MT_BACKGROUND_RED " ERROR " MT_COLOR_RESET
#define LOG_LEVEL_STRING_WARN MT_BACKGROUND_YELLOW " WARN " MT_COLOR_RESET " "
#define LOG_LEVEL_STRING_INFO MT_BACKGROUND_BLUE " INFO " MT_COLOR_RESET " "
#define LOG_LEVEL_STRING_DEBUG MT_BACKGROUND_CYAN " DEBUG " MT_COLOR_RESET
#define LOG_LEVEL_STRING_TRACE MT_BACKGROUND_WHITE " TRACE " MT_COLOR_RESET
